...
describe("Variant/set", () => {
  test("should set variant(i32) as variant(string)", () => {
    let val = Variant.from(123);
    val.set('foobaz');
    expect(val.is<string>()).toBe(true);
    expect(val.get<string>()).toBe('foobaz');
